...
select distinct
    ...
    cast(gross_asset_value as number(18,2)) as gross_asset_value,
    cast(net_asset_value as number(18,2)) as net_asset_value,
    cast(total_liabilities as number(18,2)) as total_liabilities,
    cast(unrealized_pnl as number(18,2)) as unrealized_pnl,
    cast(realized_pnl as number(18,2)) as realized_pnl,
    valuation_method,
