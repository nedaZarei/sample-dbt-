select distinct
    ...
    cast(return_daily as number(18,8)) as return_daily,
    cast(return_mtd as number(18,8)) as return_mtd,
    cast(return_ytd as number(18,8)) as return_ytd,
    cast(benchmark_level as number(18,4)) as benchmark_level,
